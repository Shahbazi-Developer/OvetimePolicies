...
using OvetimePolicies.Infra.Data.Sql.Commands.Common;
using OvetimePolicies.Infra.Data.Sql.Queries.Common;

namespace OvetimePolicies.Endpoints.API.Extentions;
...
public static class HostingExtensions
{
    public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        //zamin
        builder.Services.AddZaminApiCore("Zamin", "OvetimePolicies");
        ...
        //CommandDbContext
        builder.Services.AddDbContext<OvetimePoliciesCommandDbContext>(c => c.UseSqlServer(configuration.GetConnectionString("CommandDb_ConnectionString"))
            .AddInterceptors(new SetPersianYeKeInterceptor(), new AddAuditDataInterceptor()));

        //QueryDbContext
        builder.Services.AddDbContext<OvetimePoliciesQueryDbContext>(c => c.UseSqlServer(configuration.GetConnectionString("QueryDb_ConnectionString")));
